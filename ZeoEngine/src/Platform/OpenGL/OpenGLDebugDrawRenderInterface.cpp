...
namespace ZeoEngine {
    ...
    const char* OpenGLDDRenderInterface::s_LinePointVertShaderSrc = "\n"
        ...
        "    v_Color      = SrgbToLinear(vec4(a_ColorPointSize.xyz, 1.0));\n"
        "}\n";
    ...
    const char* OpenGLDDRenderInterface::s_TextVertShaderSrc = "\n"
        ...
        "    v_Color     = SrgbToLinear(vec4(a_Color, 1.0));\n"
        "}\n";
    ...
    OpenGLDDRenderInterface::OpenGLDDRenderInterface(SceneRenderer* sceneRenderer)
