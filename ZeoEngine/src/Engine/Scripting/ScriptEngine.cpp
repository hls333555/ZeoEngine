...
namespace ZeoEngine {
	...
	char* ReadBytes(const std::string& filepath, U32* outSize)
	{
	...
	void Test()
	{
		...
		MonoClass* monoClass = mono_class_from_name(assemblyImage, "ZeoEngine", "Main");
		...
		// Call function
		MonoMethod* printMsgFunc = mono_class_get_method_from_name(monoClass, "PrintMsg", 0);
		...
		mono_runtime_invoke(printStringFunc, instance, &stringParam, nullptr);
	}
	...
	void ScriptEngine::InitMono()
	{
		...
		s_Data->CoreAssembly = LoadCSharpAssembly("resources/scripts/ZeoEngine-ScriptCore.dll");
