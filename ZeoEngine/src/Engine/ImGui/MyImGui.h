...
namespace ImGui {
	...
	IMGUI_API void DrawAssetThumbnail(ImTextureID thumbnailTextureID, float thumbnailSize, float rounding, bool bShouldDrawBackground, ImTextureID backgroundTextureID = nullptr);
}
