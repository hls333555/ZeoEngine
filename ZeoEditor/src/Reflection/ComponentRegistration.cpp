...
using namespace ZeoEngine;
	...
	ZE_REFL_COMPONENT(TestComponent, ZE_REFL_PROP_PAIR(DisplayName, ZE_TEXT("Test")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("测试组件")), ZE_REFL_PROP(Inherent))
		...
		ZE_REFL_DATA_SETTER_GETTER(TestComponent, FloatSetterGetterVar, SetFloatSetterGetterVar, GetFloatSetterGetterVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Basic")))
		ZE_REFL_DATA(TestComponent, BoolDeqVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, Ui8VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, Ui32VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, Ui64VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, I8VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")), ZE_REFL_PROP_PAIR(ClampMin, 1))
		ZE_REFL_DATA(TestComponent, I32VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, I64VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, FloatVecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, DoubleVecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, EnumVecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, StringVecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, Vec2VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, Vec3VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, ColorVecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, Texture2DVecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, ParticleTemplateVecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA(TestComponent, TestStruct1VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")))
		ZE_REFL_DATA_GETTER_REF(TestComponent, TestStruct2VecGetterVar, GetTestStruct2VecGetterVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")));
#endif
