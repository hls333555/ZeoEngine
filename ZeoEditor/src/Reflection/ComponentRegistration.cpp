...
using namespace ZeoEngine;
	...
	ZE_REFL_TYPE(TestComponent, ZE_REFL_PROP_PAIR(DisplayName, ZE_TEXT("Test")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("测试组件")), ZE_REFL_PROP(InherentType))
		...
		ZE_REFL_DATA_REF(TestComponent, Ui64Var, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Basic")), ZE_REFL_PROP_PAIR_WITH_CAST(ClampMin, 1, uint64_t))
		ZE_REFL_DATA_REF(TestComponent, I8Var, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Basic")), ZE_REFL_PROP_PAIR_WITH_CAST(ClampMin, 1, int8_t))
		ZE_REFL_DATA_REF(TestComponent, I32Var, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Basic")), ZE_REFL_PROP_PAIR_WITH_CAST(ClampMin, 1, int32_t))
		ZE_REFL_DATA_REF(TestComponent, I64Var, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Basic")), ZE_REFL_PROP_PAIR_WITH_CAST(ClampMin, 1, int64_t))
		...
		ZE_REFL_DATA_REF(TestComponent, I8VecVar, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Sequence Container")), ZE_REFL_PROP_PAIR_WITH_CAST(ClampMin, 1, int8_t))
...
#define ZE_REFL_PARTICLE_VARIATION_TYPE(_type)											\
	...
	ZE_REFL_TYPE(ParticleSystemDetailComponent, ZE_REFL_PROP(HideTypeHeader), ZE_REFL_PROP(InherentType))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, IsLocalSpace, SetLocalSpace, IsLocalSpace, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Emitter")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("是否在局部空间模拟粒子")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, LoopCount, SetLoopCount, GetLoopCount, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Emitter")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("循环次数。若小于等于0, 则为无限循环")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, LoopDuration, SetLoopDuration, GetLoopDuration, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Emitter")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("每次循环的时长")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, SpawnRate, SetSpawnRate, GetSpawnRate, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Emitter")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("每秒总共生成的粒子数，该变量决定粒子的生成速度。若小于等于0，则不生成")))
		ZE_REFL_DATA_SETTER_GETTER_REF(ParticleSystemDetailComponent, BurstList, GetBurstList, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Emitter")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("每个时间点一次性生成的粒子数列表")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, InitialPosition, SetInitialPosition, GetInitialPosition, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的初始位置")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, InitialRotation, SetInitialRotation, GetInitialRotation, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的初始旋转")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, RotationRate, SetRotationRate, GetRotationRate, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的旋转速度")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, SizeBegin, SetSizeBegin, GetSizeBegin, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的初始大小")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, SizeEnd, SetSizeEnd, GetSizeEnd, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的最终大小")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, InitialVelocity, SetInitialVelocity, GetInitialVelocity, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的初始速度")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, InheritVelocity, SetInheritVelocity, GetInheritVelocity, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("决定粒子所能继承的速度。该变量只有在非局部空间有效")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, ColorBegin, SetColorBegin, GetColorBegin, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的初始颜色")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, ColorEnd, SetColorEnd, GetColorEnd, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的最终颜色")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, Lifetime, SetLifetime, GetLifetime, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Particle")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的生命周期")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, Texture, SetTexture, GetTexture, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Renderer")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("粒子的材质贴图")))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, SubImageSize, SetSubImageSize, GetSubImageSize, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Renderer")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("决定如何分割贴图来用于UV动画。x为列数，y为行数")), ZE_REFL_PROP_PAIR(ClampMin, 0.0f))
		ZE_REFL_DATA_SETTER_GETTER(ParticleSystemDetailComponent, MaxDrawParticles, SetMaxDrawParticles, GetMaxDrawParticles, ZE_REFL_PROP_PAIR(Category, ZE_TEXT("Emitter")), ZE_REFL_PROP_PAIR(Tooltip, ZE_TEXT("最多生成的粒子数")));
